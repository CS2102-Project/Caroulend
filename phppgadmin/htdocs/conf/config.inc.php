<?php
	...
	// Database port on server (5433 is the PostgreSQL default)
	...
	$conf['servers'][0]['pg_dump_path'] = '/Applications/mappstack-7.0.23-0/postgresql/bin/pg_dump';
	$conf['servers'][0]['pg_dumpall_path'] = '/Applications/mappstack-7.0.23-0/postgresql/bin/pg_dumpall';
