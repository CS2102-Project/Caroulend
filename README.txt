...
/Applications/mappstack-7.0.23-0/apache2/htdocs
...
You should copy the "demo" folder into the /Applications/mappstack-7.0.23-0/apps 
folder and add the following line at the end of the
/Applications/mappstack-7.0.23-0/apache2/conf/bitnami/bitnami-apps-prefix.conf
...
configuration in the "/Applications/mappstack-7.0.23-0/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "/Applications/mappstack-7.0.23-0/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"/Applications/mappstack-7.0.23-0/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "/Applications/mappstack-7.0.23-0/apps/demo/conf/httpd-vhosts.conf"
